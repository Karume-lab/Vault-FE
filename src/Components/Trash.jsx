...
const Trash = () => {
    ...
    return (
        <div className="rounded-2xl bg-customCactus-100   w-full h-full overflow-hidden flex flex-col p-2 text-customCactus-400">
            <div className="pt-1 pl-2 rounded-r-2xl-2xl rounded-t-2xl ">
                <p className="ml-2 font-bold text-center text-2xl">TRASH</p>
            </div>
